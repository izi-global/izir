...
# from izi.core.files.temp import NamedTemporaryFile
# from izi.core.management.base import BaseCommand, CommandError
# from izi.core.management.utils import (
#     find_command, handle_extensions, popen_wrapper,
# )
# from izi.utils.encoding import DEFAULT_LOCALE_ENCODING
# from izi.utils.functional import cached_property
# from izi.utils.jslex import prepare_js_for_gettext
# from izi.utils.text import get_text_list
# from izi.utils.translation import templatize
...
class Command(BaseCommand):
    ...
    def copy_plural_forms(self, msgs, locale):
        ...
        """
        izir_dir = os.path.normpath(os.path.join(os.path.dirname(izi.__file__)))
        if self.domain == 'djangojs':
            domains = ('djangojs', 'django')
        else:
            domains = ('django',)
        for domain in domains:
            django_po = os.path.join(izir_dir, 'conf', 'locale', locale, 'LC_MESSAGES', '%s.po' % domain)
