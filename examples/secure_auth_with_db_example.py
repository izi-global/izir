...
api_key_authentication = izi.authentication.api_key(authenticate_key)
basic_authentication = izi.authentication.basic(authenticate_user)
...
@izi.get('/api/get_api_key', requires=basic_authentication)
def get_token(authed_user: izi.directives.user):
    """
    Get Job details
    :param authed_user:
    :return:
...
@izi.get(('/api/job', '/api/job/{job_id}/'), requires=api_key_authentication)
